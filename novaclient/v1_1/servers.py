...
class ServerManager(base.BootingManagerWithFind):
    ...
    def list(self, detailed=True, search_opts=None):
        ...
        if search_opts is None:
            search_opts = {}
        #print("===========================inside servers list ",servers,"==============================")
        ...
        if detailed:
            detail = "/detail"
        print("=============== Query String inside servers list [/servers%s%s", detail, query_string, "servers]\n")
	return self._list("/servers%s%s" % (detail, query_string), "servers")
    def listall(self, detailed=True, search_opts=None):
        """
        Get a list of servers.
        Optional detailed returns details server info.
        Optional reservation_id only returns instances with that
