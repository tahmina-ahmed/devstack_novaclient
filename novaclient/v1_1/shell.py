...
def do_list(cs, args):
    """List active servers."""
    """List active servers."""
    print("================inside do_list args=====",args,"==============\n")
    imageid = None
    flavorid = None
    if args.image:
    ...
    print("filters value is ",filters)
    formatters = {}
    field_titles = []
    if args.fields:
...
def do_listall(cs, args):
    """List active servers."""
    print("================inside do_listall args=====",args,"==============\n")
    imageid = None
    flavorid = None
    if args.image:
        imageid = _find_image(cs, args.image).id
    ...
    filters = {'flavor': lambda f: f['id'],
               'security_groups': utils._format_security_groups}
    print("================inside do_listall filters=====",filters,"==============\n")
    ...
    servers = cs.servers.listall(search_opts=search_opts)
    print("================inside do_listall servers=====",servers,"==============\n")
