...
class OpenStackComputeShell(object):
    ...
    def _find_actions(self, subparsers, actions_module):
    	#print 'The modules are {0}'.format(actions_module[0])
	...
	print("options form main shell",options)
        self.setup_debugging(options.debug)
	print ('args {} and argv{}'.format(args,argv))
        ...
        print("===========================inside shell main subcommand_parser",subcommand_parser,"==============================\n")
        # Parse args once to find version and debug settings
	...
	print ("os_auth_system_flg1")
        if os_auth_system and os_auth_system != "keystone":
	    print ("os_auth_system")
	...
	print ("args.func is",args.func)
        args.func(self.cs, args)
	print ("args is now @678{}",args)
        if args.timings:
